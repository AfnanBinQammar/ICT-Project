...
* **🏠 Home (`main.html`):** The landing page providing an overview of the NGO's mission.
* **ℹ️ About (`about.html`):** Details about the organization's history and vision.
* **🏆 Achievements (`program.html`):** Showcases the NGO's programs, success stories, and milestones.
* **🤝 Donate (`donate.html`):** A dedicated page to encourage user contributions and support.
* **📞 Contact (`contact.html`):** Contains contact information and forms for user inquiries.
* **🔐 Authentication:**
    * **Login (`login.html`)**: User access portal.
